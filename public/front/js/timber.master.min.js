...
$(document).ready(function() {
    ...
    var i, t = ".wrapper",
        e = ".header",
        n = ".side-navigation-wrapper",
        a = "#side-nav-show a",
        s = "#side-nav-hide a",
        o = ".reveal-side-navigation",
        c = ".element-reveal-left",
        r = ".element-reveal-right",
        l = ".element-show-left",
        d = ".element-show-right",
        u = ".side-nav-open",
        v = ".content-side-navigation-screen",
        h = 500,
        f = "easeInOutQuint",
        m = {
            init: function() {
                $("body").data("aux-nav", !1);
                var i, e = $(n).hasClass("enter-right") ? "right" : "left";
                Z ? i = "left" === e ? c : r : (i = "left" === e ? l : d, $(n).addClass("hide")), i = i.split(".").join(""), u = u.split(".").join(""), $(a).on("click", function(a) {
                    if (a.preventDefault(), $(n).hasClass("active")) m.closeNav(i);
                    else {
                        E.state(!0), $("body").data("aux-nav", !0), Z ? ($(o).addClass(i).css({
                            transitionDuration: h + "ms",
                            transitionTimingFunction: et[f]
                        }), $(n).addClass("active").css({
                            transitionDuration: h + "ms",
                            transitionTimingFunction: et[f]
                        }), $("body").addClass(u)) : ($(t).addClass(i), $(n).removeClass("hide").addClass("active")), x.state(!0), $(n).on(tt, function(i) {
                            return i.target !== $(this)[0] ? !1 : (i.stopPropagation(), void $(this).off(tt))
                        });
                        var s = $('<a href="#" />').addClass(v.split(".").join("")).appendTo($(t));
                        $(s).on("click", function(t) {
                            t.preventDefault(), m.closeNav(i)
                        }), $(s).swipeIt({
                            preventTouchOn: n,
                            onSwipeEnd: function(t) {
                                "right" === e ? "left" === t && m.closeNav(i) : "right" === t && m.closeNav(i)
                            }
                        })
                    }
                }), $(s).on("click", function(t) {
                    ...
                    x.state($("body").data("aux-nav") ? !0 : !1)
                })
            },
            closeNav: function(i) {
                Z ? (E.state(!0), $(o).removeClass(i), $(n).removeClass("active"), $(n).on(tt, function(i) {
                    return i.target !== $(this)[0] ? !1 : (i.stopPropagation(), x.state(!1), $(this).off(tt), void $("body").removeClass(u))
                })) : ($(t).removeClass(i), $(n).addClass("hide").removeClass("active")), $("body").data("aux-nav", !1), $(t).find(v).remove()
            }
        },
        p = ".overlay-navigation-wrapper",
        b = ".overlay-navigation-inner",
        g = "#overlay-nav-show a",
        C = "#overlay-nav-hide a",
        w = 500,
        y = "easeInOutQuint",
        z = {
            init: function() {
                $(g).on("click", function(i) {
                    i.preventDefault(), $(p).hasClass("active") ? z.closeNav() : ($("body").data("aux-nav", !0), $(p).addClass("active").css(Z ? {
                        top: 0,
                        transitionDuration: w + "ms",
                        transitionTimingFunction: et[y]
                    } : {
                        top: 0
                    }), $(p).on(tt, function(i) {
                        return i.target !== $(this)[0] ? !1 : (i.stopPropagation(), x.state(!0), void $(this).off(tt))
                    }))
                }), $(b).on("click", function(i) {
                    i.target === this && z.closeNav()
                }), $(C).on("click", function(i) {
                    i.preventDefault(), z.closeNav()
                }), $(window).on("resize", function() {
                    x.state($("body").data("aux-nav") ? !0 : !1)
                })
            },
            closeNav: function() {
                Z ? ($(p).removeClass("active"), $(p).on(tt, function(i) {
                    return i.target !== $(this)[0] ? !1 : (i.stopPropagation(), x.state(!1), $(p).css({
                        top: "-100%"
                    }), void $(this).off(tt))
                })) : $(p).removeClass("active").css({
                    top: "-100%"
                }), $("body").data("aux-nav", !1)
            }
        },
        T = ".side-navigation-wrapper, .overlay-navigation-wrapper",
        k = ".sub-menu",
        O = ".contains-sub-menu",
        I = {
            init: function() {
                $(T).find(O).each(function() {
                    $(this).on("click", function(i) {
                        i.preventDefault(), $(this).parent().hasClass("current") ? $(this).parent().removeClass("current") : ($(this).closest("nav").children("ul").children().removeClass("current"), $(this).parent().addClass("current")), E.state(!0);
                        var t = $(this).siblings(k).children(),
                            e = 0;
                        t.each(function() {
                            e += $(this).outerHeight()
                        }), $(this).siblings(k).hasClass("open") ? $(this).closest(T).find(k).css({
                            height: 0
                        }).removeClass("open") : ($(this).closest(T).find(k).css({
                            height: 0
                        }).removeClass("open"), $(this).siblings(k).css({
                            height: e + "px"
                        }), $(this).siblings(k).addClass("open"))
                    })
                })
            }
        },
        x = {
            state: function(i) {
                nt ? i ? $("body").addClass("aux-navigation-active") : $("body").removeClass("aux-navigation-active") : i ? $("body").addClass("aux-navigation-active") : $("body").data("aux-nav") || $("body").removeClass("aux-navigation-active")
            }
        },
        N = ".header, .header-inner, .header .logo, .header .navigation, .reveal-side-navigation, .side-navigation-wrapper",
        E = {
            init: function() {
                nt || $(window).on("scroll", function() {
                    E.state(!0)
                }), $(window).on("resize", function() {
                    E.state(!1)
                })
            ...
            state: function(i) {
                i ? $(N).removeClass("no-transition") : $(N).addClass("no-transition")
            }
        },
        D = 300,
        Q = ".scroll-to-top",
        ...
        P = {
            init: function() {
                $(window).on("scroll", function() {
                    return $(Q).is("[data-no-hide]") ? !1 : void($(this).scrollTop() > D ? $(Q).fadeIn(B) : $(Q).fadeOut(B))
                }), $(Q).on("click", function(i) {
                    i.preventDefault(), P.scrollUp()
                })
            },
            scrollUp: function() {
                $("html, body").animate({
        ...
        V = {
            ...
            tabs: function() {
                $(A).each(function() {
                    var i = $(this).find("li a");
                    $(this).find(".tab-panes .active").addClass("fade-in"), i.each(function() {
                        $(this).on("click", function() {
                            var i = $(this).attr("href"),
                                t = $(this).closest(".tabs").find(i);
                            $(this).closest(".tab-nav").find(".active").removeClass("active"), $(this).parent().addClass("active"), $(this).closest(".tabs").find(".tab-panes .active").removeClass("active fade-in"), t.addClass("active");
                            var e = null;
            ...
            accordions: function() {
                $(F).each(function() {
                    var i = $(this).find("li a");
                    i.each(function() {
                        $(this).closest(F).is("[data-toggle-icon]") && ($(this).find("span").length || $(this).parent().hasClass("active") ? !$(this).find("span").length && $(this).parent().hasClass("active") && $(this).prepend('<span class="' + H + '" />') : $(this).prepend('<span class="' + S + '" />')), $(this).on("click", function() {
                            var i = $(this),
                                t = i.attr("href"),
                                e = i.closest(F).find(t),
                                n = i.closest(F).find("li > div");
                            i.closest(F).find("li.active > div").each(function() {
                                var i = $(this).children().outerHeight();
                                $(this).addClass("no-transition").css({
                                    height: i + "px"
                                })
                            });
                            var a = null;
                            return clearTimeout(a), a = i.parent().hasClass("active") ? setTimeout(function() {
                                i.closest(F).is("[data-toggle-multiple]") ? i.siblings(e).removeClass("no-transition").css({
                                    height: 0
                                }) : i.closest(F).find("li.active > div").removeClass("no-transition").css({
                                    height: 0
                                }), i.parent().removeClass("active")
                            }, 50) : setTimeout(function() {
                                var t = i.siblings(e).find(M).outerHeight();
                                i.closest(F).is("[data-toggle-multiple]") || (n.removeClass("no-transition").css({
                                    height: 0
                                }), i.closest(F).find("li").removeClass("active")), i.parent().addClass("active"), i.siblings(e).removeClass("no-transition").css({
                                    height: t + "px"
                                })
                            }, 50), i.find("." + H).length ? i.find("." + H).removeClass(H).addClass(S) : i.find("." + S).length && (i.closest(F).is("[data-toggle-multiple]") || i.closest("ul").find("." + H).removeClass(H).addClass(S), i.find("." + S).removeClass(S).addClass(H)), !1
                        })
                    }), $(window).on("resize", function() {
                        $(F).each(function() {
            ...
            dismissable: function() {
                $(W).each(function() {
                    $(this).find(".close").length || $(this).prepend('<a href="" class="close icon-cancel" />'), $(this).find(".close").on("click", function(i) {
                        i.preventDefault(), Z ? $(this).parent().css({
                            transitionProperty: "opacity",
                            opacity: 0,
                            transitionDuration: j + "ms",
                            transitionTimingFunction: et[L]
                        }).on(tt, function(i) {
                            return i.stopPropagation(), i.target !== $(this)[0] ? !1 : void $(this).remove()
                        }) : $(this).parent().animate({
                            opacity: 0
                        }, J, L, function() {
                            $(this).remove()
                ...
                $(R).each(function() {
                    $(this).children(".button, button").not().each(function() {
                        $(this).on("click", function(t) {
                            ...
                            return $(this).parent().hasClass("disabled") ? !1 : ($(".dropdown-list").not($(e)).removeClass("active"), $(e).hasClass("active") ? ($(e).removeClass("active"), $(this).removeClass("active")) : ($(e).addClass("active"), $(this).addClass("active")), void $(document).on("click.closeDropdown", function(t) {
                                $(t.target).closest(R).length || i()
                            }))
                        }), $(this).parent().children(".dropdown-list").find("li a").on("click", function(i) {
                            i.preventDefault(), $(".dropdown-list").removeClass("active"), $(this).removeClass("active")
                        }), nt || $(window).on("scroll", function() {
                            i()
                        }), $(e).find(".navigation > ul > li > a").mouseenter(function() {
                            i()
                        });
                        var i = function() {
                            $(R).each(function() {
            ...
            rollovers: function() {
                Z ? $(U).each(function() {
                    var i, t = $(this).data("hover-speed") ? $(this).data("hover-speed") : J,
                        e = $(this).data("hover-easing") ? $(this).data("hover-easing") : K,
                        n = $(this).data("hover-bkg-opacity") ? $(this).data("hover-bkg-opacity") : 1;
                    if ($(this).data("hover-bkg-color")) {
                        var a = $(this).data("hover-bkg-color");
                        a = a.replace("#", "");
                        var s = parseInt(a.substring(0, 2), 16),
                            o = parseInt(a.substring(2, 4), 16),
                            c = parseInt(a.substring(4, 6), 16);
                        i = "rgba( " + s + "," + o + "," + c + "," + n / 1 + " )"
                    } else i = $(this).find(G).css("background-color");
                    $(this).find(q).css({
                        transitionDuration: t + "ms",
                        transitionTimingFunction: et[e]
                    }), $(this).find(G).css({
                        backgroundColor: i
                    })
    ...
    for (var it in _) void 0 !== Y[_[it]] && (i = "-" + _[it].replace("Transform", "").toLowerCase());
    ...
    window.onpageshow = function(i) {
        i.persisted && $("body").addClass("page-fade-reset").removeClass("page-fade-out")
    };
    var nt = !1;
    ...
    var at = "WebkitAppearance" in document.documentElement.style;
    at && (document.getElementsByTagName("body")[0].className += " webkit");
    var st = /constructor/i.test(window.HTMLElement);
    st && (document.getElementsByTagName("body")[0].className += " safari-browser");
    var ot = document.all && document.addEventListener || "-ms-scroll-limit" in document.documentElement.style && "-ms-ime-align" in document.documentElement.style;
    ot && (document.getElementsByTagName("body")[0].className += " ie-browser"), m.init(), z.init(), I.init(), E.init(), P.init(), V.init()
});
/**
 *	Avalanche Slider
 *	Version: 1.1.1
...
! function(a, e, t, i) {
    ...
    function o(e, i, n) {
        var o = e.find(".tms-slide"),
            r = 0;
        o.each(function() {
            {
                var o = a(this),
                    l = o.find("img").length,
                    d = o.find("iframe, video").length;
                o.children(".tms-caption").length
            }
            b(o, i);
            var c = a('<div class="tm-loader"><div id="circle" /></div>');
            if (l > 0 && (i.lazyLoad ? c.appendTo(o) : e.find(c).length || c.appendTo(e)), d) {
                V && o.is("[data-video-bkg]") && o.children("video").css({
                    display: "none"
                });
                var h = o.find("iframe, video");
                C(h, i), v(o, i), g(e, i)
            }
            l ? o.find("img").each(function(e, d) {
                d = a(this).data("src");
                var c = d.substr(d.lastIndexOf("."));
                if ((t.isRetinaDevice() && i.retinaSupport || t.isRetinaDevice() && a(this).is("[data-retina]")) && (!V && !i.retinaSupportMobile || V && i.retinaSupportMobile) && (d.match(/\.(svg)/i) || (d = a(this).data("src").replace(c, i.retinaSuffix + c))), o.data("overlay-bkg-color") && !o.find(".tms-overlay").length) var h = o.data("overlay-bkg-color").replace("#", ""),
                    u = o.data("overlay-bkg-opacity") ? o.data("overlay-bkg-opacity") : .5,
                    p = parseInt(h.substring(0, 2), 16),
                    f = parseInt(h.substring(2, 4), 16),
                    m = parseInt(h.substring(4, 6), 16),
                    g = "rgba( " + p + "," + f + "," + m + "," + u / 1 + " )",
    ...
    function s(a, e, t, i) {
        ...
        if (v(a, t), g(n, t), t.carousel && !t.lazyLoad && (o.children().css({
                opacity: 1
            }), o.css({
                opacity: 0
            })), n.find("iframe, video").css({
                opacity: 1
            }), e === o.children().length && t.onLoadEnd && t.onLoadEnd(), t.lazyLoad || e !== o.children().length ? t.lazyLoad && 1 === e && (n.data("loaded", !0), t.autoAdvance && i.initSlideshow()) : (n.data("loaded", !0), t.autoAdvance && i.initSlideshow()), t.lazyLoad) {
            if (a.find(".tm-loader").length && a.find(".tm-loader").remove(), (a.is(s) || t.carouselVisible > 1) && a.find(".tms-caption").show(), !a.hasClass("active")) return !1;
            k ? (clearTimeout(l), l = setTimeout(function() {
                h(s, 1, 0, 0, 0, 0, 0, 0, 1, 1e3, 0, "easeIn", t)
            }, 50)) : a.animate({
                opacity: 1
            }), clearTimeout(r), r = setTimeout(function() {
                p(s, t)
            }, 300)
        } else e === o.children().length && (n.find(".tm-loader").length && n.find(".tm-loader").remove(), s.find(".tms-caption").show(), t.carouselVisible > 1 && n.find(".tms-caption").show(), k ? t.carousel ? h(o, 1, 0, 0, 0, 0, 0, 0, 1, 1e3, 0, "easeIn", t) : h(s, 1, 0, 0, 0, 0, 0, 0, 1, 1e3, 0, "easeIn", t) : t.carousel ? o.animate({
            opacity: 1
        }) : s.animate({
            opacity: 1
        }), clearTimeout(r), r = setTimeout(function() {
    ...
    var r = function(s, r) {
            var c, p = a.extend({}, a.fn.avalancheSlider.tmsOpts, r),
                w = a(s),
                y = this,
                x = p.fulscreen ? a(t).width() : p.fullwidth ? p.scaleUnder : parseFloat(w.data("width") ? w.data("width") : w.css("width")),
                $ = p.fulscreen ? a(t).height() : parseFloat(w.data("height") ? w.data("height") : w.css("height")),
                S = w.find(".tms-slides"),
                C = S.children("li:first-child").addClass("active"),
                z = [];
            if (S.children(".tms-slide").each(function(e) {
                    e++, a(this).attr("id", "tms-slide-" + e), z.push(a(this).attr("id")), p.carousel || a(this).not(".active").css(k ? {
                        transition: "none",
                        transform: "translate3d( 100%, 0, 0)"
                    } : {
                        left: "100%"
                    }), (p.forceFit || a(this).is("[data-force-fit]")) && a(this).addClass("tms-forcefit")
                }), p.lazyLoad || C.css({
                    opacity: 0
                }), p.scaleUnder = w.data("scale-under") ? w.data("scale-under") : p.scaleUnder, p.scaleMinHeight = w.data("scale-min-height") ? w.data("scale-min-height") : p.scaleMinHeight, p.animation = w.data("animation") ? w.data("animation") : p.animation, c = p.animation, p.easing = w.data("easing") ? w.data("easing") : p.easing, p.speed = w.data("speed") ? w.data("speed") : p.speed, p.carousel = w.data("carousel") ? w.data("carousel") : p.carousel, p.carouselVisible = w.data("carousel-visible-slides") ? w.data("carousel-visible-slides") : p.carouselVisible, p.carouselVisible = p.carouselVisible > S.children().length ? S.children().length : p.carouselVisible, p.showProgressBar = w.is('[data-progress-bar="false"]') ? !1 : p.showProgressBar, p.autoAdvance = w.is("[data-auto-advance]") ? !0 : p.autoAdvance, p.interval = w.data("auto-advance-interval") ? w.data("auto-advance-interval") : p.interval, p.pauseOnHover = w.is('[data-pause-on-hover="false"]') ? !1 : p.pauseOnHover, p.navArrows = w.is('[data-nav-arrows="false"]') ? !1 : p.navArrows, p.navPagination = w.is('[data-nav-pagination="false"]') ? !1 : p.navPagination, p.navShowOnHover = w.is('[data-nav-show-on-hover="false"]') ? !1 : p.navShowOnHover, C.is("[data-nav-dark]") && (w.addClass("tms-nav-dark"), w.is("[data-featured-slider]") && a("header").addClass("nav-dark")), p.fullscreen && (w.css({
                    top: 0,
                    left: 0
                }).addClass("tms-fullscreen"), p.carouselVisible = 1, p.fsUseHeightOf = p.fsUseHeightOf || w.data("fs-use-height") ? p.fsUseHeightOf && !w.data("fs-use-height") ? p.fsUseHeightOf : w.data("fs-use-height") : "", p.fsUseHeightOf = p.fsUseHeightOf ? "parent" === p.fsUseHeightOf ? w.parent() : w.closest("." + p.fsUseHeightOf) : ""), p.parallax = w.is("[data-parallax]") ? !0 : p.parallax, p.parallaxSpeed = w.data("parallax-speed") ? w.data("parallax-speed") : p.parallaxSpeed, p.parallaxScaleOut = w.is("[data-parallax-scale-out]") ? !0 : p.parallaxScaleOut, p.parallaxFadeOut = w.is("[data-parallax-fade-out]") ? !0 : p.parallaxFadeOut, p.captionScaling || w.addClass("tms-caption-no-scaling"), !p.carousel && p.carouselVisible && (p.carouselVisible = 1), p.carouselVisible > 1 && (p.animation = "slide"), p.carousel && w.addClass("tms-carousel"), p.carouselScaleHeight && w.addClass("tms-scalable-height"), V && (p.autoPlay = !1, p.useVideoAPI = !1), p.navShowOnHover && w.addClass("show-on-hover"), p.navArrows && S.children().length > 1) {
                var O = a('<a href="#" />').attr("id", "tms-prev").addClass("tms-arrow-nav").appendTo(w),
                    F = a('<a href="#" />').attr("id", "tms-next").addClass("tms-arrow-nav").appendTo(w);
                O.each(function() {
                    a(this).on("click", function(a) {
                        a.preventDefault(), p.autoAdvance && w.data("loaded") && y.resetSlideshow(), y.prevSlide()
                    })
                }), F.each(function() {
                    a(this).on("click", function(a) {
                        a.preventDefault(), p.autoAdvance && w.data("loaded") && y.resetSlideshow(), y.nextSlide()
                    })
                }), p.lazyLoad && w.find(".tms-arrow-nav").css({
                    display: "block"
                })
            }
            if (p.navPagination && S.children().length > 1) {
                for (var A = a("<div>").addClass("tms-pagination").appendTo(w), H = 1; H < S.children().length + 1; H++) w.find(A).append('<a href="#" id="tms-pagination-' + H + '" data-index="' + H + '" class="tms-bullet-nav" />');
                var P = w.find("bullets" === p.paginationType ? ".tms-bullet-nav" : ".tms-thumb-nav");
                P.each(function() {
                    a(this).on("click", function() {
                        return C = w.find("li.active"), a(this).hasClass("active") ? !1 : (p.autoAdvance && w.data("loaded") && y.resetSlideshow(), parseFloat(a(this).data("index")) > parseFloat(A.find(".active").data("index")) ? y.slideTo(a(this).data("index"), "next") : y.slideTo(a(this).data("index"), "prev"), !1)
                    })
                }), A.find(".tms-bullet-nav:first-child").addClass("active"), p.lazyLoad && A.css({
                    display: "block"
                })
            }
            if (p.navKeyboard && S.children().length > 1) {
                var I = [];
                a(e).on("keydown", function(a) {
                    return I[a.keyCode] = !0, I[37] && I[39] ? !1 : (I[37] ? (p.autoAdvance && w.data("loaded") && y.resetSlideshow(), p.lazyLoad ? y.prevSlide() : w.data("loaded") && y.prevSlide()) : I[39] && (p.autoAdvance && w.data("loaded") && y.resetSlideshow(), p.lazyLoad ? y.nextSlide() : w.data("loaded") && y.nextSlide()), i)
                }).on("keyup", function(a) {
                    I[a.keyCode] = !1
                })
            }
            w.swipeIt({
                ...
                onSwipeEnd: function(a) {
                    "left" === a ? y.prevSlide() : y.nextSlide()
                }
            }), a(t).on("resize", function() {
                w.data("first-load") && (x = p.fulscreen ? a(t).width() : p.fullwidth ? p.scaleUnder : parseFloat(w.data("width") ? w.data("width") : w.css("width")), $ = p.fulscreen ? a(t).height() : parseFloat(w.data("height") ? w.data("height") : w.css("height")), w.data("refW", x).data("refH", $).data("carousel-height", $));
                var e = w.find("li.active, li.target");
                p.carousel && p.carouselVisible > 1 ? S.children(".tms-slide").each(function() {
                    v(a(this), p)
                }) : v(e, p), g(w, p), w.addClass("resizing"), T(function() {
                    w.removeClass("resizing")
                }, 300, "resize")
            }), w.parent().hasClass("tm-slider-parallax-container") && p.parallax ? (a(t).on("scroll", function() {
                l(w, p)
            }), d(w, p)) : !w.parent().hasClass("tm-slider-parallax-container") && p.parallax && console.log("Add the class tm-slider-parallax-container to slider parent"), w.data("setup", !1).data("loaded", !1).data("first-load", !0).data("transitioning", !1).data("refW", x).data("refH", $).data("carousel-height", $), n(w), g(w, p), p.onSetup && p.onSetup();
            var E, D, L, W, B, R, q, j = null,
                U = null;
            y.initSlideshow = function() {
                return E || S.children().length < 2 ? !1 : (p.autoAdvance = !0, !V && p.pauseOnHover && (S.on("mouseleave ", y.resumeSlideshow), S.on("mouseenter ", y.pauseSlideshow)), p.showProgressBar && (q = a("<div>").addClass("tms-progress-bar").appendTo(w)), y.startSlideshow(), Q(p.interval), D = (new Date).getTime(), B = p.interval, p.onSlideshowStart && p.onSlideshowStart(), i)
            }, y.startSlideshow = function(a) {
                a = a ? W : p.interval, E = setInterval(function() {
                    a !== p.interval && (clearInterval(E), a = p.interval, B = p.interval, y.startSlideshow()), D = (new Date).getTime(), i !== q && q.css({
                        transition: "none",
                        width: "0px"
                    }), Q(p.interval), y.nextSlide()
                }, a)
            }, y.pauseSlideshow = function() {
                return R || !E ? !1 : (clearInterval(E), L = (new Date).getTime(), W = 50 > B - (L - D) ? 50 : B - (L - D), B = 0 === B ? p.interval : W, i !== q && q.stop().css({
                    width: q.width() + "px"
                }), R = !0, p.onSlideshowPause && p.onSlideshowPause(), i)
            }, y.resumeSlideshow = function() {
                return R ? (clearInterval(E), w.data("ssPaused", !1), D = (new Date).getTime(), Q(W), y.startSlideshow(W), R = !1, i) : !1
            }, y.resetSlideshow = function() {
                return E ? (clearInterval(E), i !== q && q.css({
                    transition: "none",
                    width: "0px"
                }), Q(p.interval), D = (new Date).getTime(), W = p.interval, B = p.interval, y.startSlideshow(p.interval), i) : !1
            }, y.endSlideshow = function() {
                return E ? (clearInterval(E), E = "", R = !1, !V && p.pauseOnHover && (S.off("mouseleave ", y.resumeSlideshow), S.off("mouseenter ", y.pauseSlideshow)), i !== q && q.remove(), p.onSlideshowEnd && p.onSlideshowEnd(), i) : !1
            };
            var Q = function(a) {
                return i === q ? !1 : (k ? (clearTimeout(j), j = setTimeout(function() {
                    q.css({
                ...
                }, 50)) : q.stop(!0, !0).animate({
                    width: "100%"
                }, a), i)
            };
            y.nextSlide = function() {
                if (w.data("transitioning")) return !1;
                var e;
                C = w.find("li.active");
                var t = z[a.inArray(C.attr("id"), z) + 1];
                if (e = a.inArray(t, z) + 1 === 0 ? 1 : a.inArray(t, z) + 1, p.carousel && p.carouselVisible > 1) {
                    var i = m(w, p);
                    1 !== i && (e = e === S.children().length - (i - 2) ? 1 : a.inArray(t, z) + 1)
                }
                this.slideTo(e, "next")
            }, y.prevSlide = function() {
                if (w.data("transitioning")) return !1;
                var e;
                C = w.find("li.active");
                var t = z[a.inArray(C.attr("id"), z) - 1];
                if (e = a.inArray(t, z) + 1 === 0 ? S.children().length : a.inArray(t, z) + 1, p.carousel && p.carouselVisible > 1) {
                    var i = m(w, p);
                    e = e === S.children().length ? S.children().length - (i - 1) : a.inArray(t, z) + 1
                }
                this.slideTo(e, "prev")
            }, y.slideTo = function(e, t) {
                if (w.data("first-load", !1), t || (C = w.find("li.active")), w.data("transitioning") || e === a.inArray(C.attr("id"), z) + 1) return !1;
                f(w, e);
                var i = w.width(),
                    n = w.height(),
                    o = w.find("#tms-slide-" + e);
                o.addClass("target").css({
                    zIndex: 2,
                    opacity: 0 === s ? 0 : 1
                }), C.css({
                    zIndex: 1
                }), p.animation = o.data("animation") ? o.data("animation") : c;
                var s = "slide" === p.animation || "slideLeftRight" === p.animation ? i : 0,
                    r = "slideTopBottom" === p.animation ? n : 0;
                s *= p.carousel ? e - 1 : 1;
                var l = "scaleIn" === p.animation ? 1 - p.scaleFactor : "scaleOut" === p.animation ? 1 + p.scaleFactor : 1;
                w.removeClass("tms-nav-dark"), a("header").removeClass("nav-dark"), o.is("[data-nav-dark]") && (w.addClass("tms-nav-dark"), w.is("[data-featured-slider]") && a("header").addClass("nav-dark")), b(o, p), (o.children("img").data("loaded") || !o.children("img").length) && v(o, p), g(w, p, o), t || (t = "next"), t = p.carousel ? 1 : "next" === t ? 1 : -1;
                var d = m(w, p);
                k ? p.carousel ? h(S, 1, -(s / d) * t, 0, 0, 0, 0, 0, 1, p.speed, 0, M[p.easing], p) : (o.css({
                    opacity: 0,
                    transition: "none",
                    transform: "translate3d(" + s * t + "px," + r * t + "px, 0) scale3d(" + l + ", " + l + ", " + l + ")"
                }), clearTimeout(U), U = setTimeout(function() {
                    h(C, 1, -s * t, -r * t, 0, 0, 0, 0, l, p.speed, 0, M[p.easing], p), h(o, 1, 0, 0, 0, 0, 0, 0, 1, p.speed, 0, M[p.easing], p)
                }, 50)) : p.carousel ? (w.data("transitioning", !0), S.animate({
                    opacity: 1,
                    left: -(s / d) * t + "px"
                }, p.speed, p.easingFallback, function() {
                    u(w, p)
                })) : (w.data("transitioning", !0), o.css({
                    left: i * t + "px",
                    visibility: "visible"
                }).animate({
                    opacity: 1,
        ...
        d = function(e, i) {
            var n = a(t),
                o = n.scrollTop(),
                s = (n.height(), e.parent().height() + e.parent().offset().top - o),
                r = o * i.parallaxSpeed,
                l = i.parallaxScaleOut ? 2 - s / e.parent().height() : 1;
            l = 1 > l ? 1 : l;
            var d = i.parallaxFadeOut ? s / e.parent().height() : 1;
            !V && k && c(e.parent()) && e.css({
        ...
        h = function(e, t, i, n, o, s, r, l, d, c, h, p, f) {
            var m = e.closest(".tm-slider-container");
            (e.hasClass("active") || e.hasClass("target") || e.hasClass("tms-slides")) && (m.data("animate-first-slide") || m.data("transitioning", !0), f.onSlideBefore && f.onSlideBefore());
            var g = {};
            g.transform = "translate3d(" + i + "px, " + n + "px, " + o + "px)rotate3d( 1, 0, 0, " + s + "deg)rotate3d( 0, 1, 0, " + r + "deg)rotate3d( 0, 0, 1, " + l + "deg)scale3d(" + d + ", " + d + ", " + d + ")", g.transitionProperty = P + ", opacity", g.transitionDuration = c + "ms", g.transitionDelay = h + "ms", g.transitionTimingFunction = p, g.visibility = "visible", g.opacity = t, e.css(g).on(I, function(e) {
                e.stopPropagation(), a(this).off(I), (a(this).hasClass("target") || a(this).hasClass("tms-slides") && !m.data("animate-first-slide")) && u(m, f), a(this).hasClass("tms-caption") && a(this).css({
                    transition: ""
                }), m.data("animate-first-slide") && m.data("animate-first-slide", !1)
            })
        },
        u = function(a, e) {
            ...
            return y(t, "pause", e), 1 === e.carouselVisible && t.find(".tms-caption").not(".no-transition").css({
                ...
                visibility: "hidden"
            }), t.removeClass("active"), n.removeClass("target").addClass("active"), t = n, y(t, "play", e), e.carouselVisible > 1 ? !1 : (p(t, e), i)
        },
        p = function(e, t) {
            e.find(".tms-caption").not(".no-transition").show().each(function() {
                var e = a(this),
                    i = a(this).data("du") ? e.data("du") : t.speed,
                    n = a(this).data("de") ? e.data("de") : 0,
                    o = a(this).data("e") ? M[e.data("e")] : M[t.easing],
                    s = null;
                k ? (clearTimeout(s), s = setTimeout(function() {
                    h(e, 1, 0, 0, 0, 0, 0, 0, 1, i, n, o)
                }, 500)) : (o = t.easingFallback, e.delay(n).css({
                    visibility: "visible"
                }).animate({
                    opacity: 1
                }, i, o))
        ...
        g = function(e, t) {
            ...
            o.children().each(function() {
                t.carouselVisible = 0 === t.carouselVisible ? 1 : t.carouselVisible, a(this).css({
                    ...
                    opacity: 1,
                    visibility: "visible"
                }), u = u > a(this).outerHeight() ? u : a(this).outerHeight()
            }), 2 === c && r > o.children().length - 2 ? (i = o.children().length - 1, n = !0) : 3 === c && r > o.children().length - 3 ? (i = o.children().length - 2, n = !0) : r > o.children().length - c ? (i = o.children().length - c + 1, n = !0) : (i = r, n = !1), l.children().hide().slice(0, o.children().length - c + 1).show(), n && (s.removeClass("active"), o.find("li:nth-child(" + i + ")").addClass("active"), f(e, i)), k ? (e.data("transitioning") || o.css({
                width: h * d + "px",
                transition: "none",
                transform: "translate3d(" + -(h * i) + "px, 0, 0)"
            }), clearTimeout(p), p = setTimeout(function() {
                o.css({
                    transitionProperty: "opacity, " + P,
        ...
        v = function(e, i) {
            var n = e.closest(".tm-slider-container, .featured-media"),
                o = n.parent().width(),
                s = i.fsUseHeightOf ? i.fsUseHeightOf.height() : a(t).height(),
                r = n.data("refW"),
                l = n.data("refH"),
                d = i.fullscreen ? a(t).width() / s : r / l,
                c = n.data("external-padding") ? parseFloat(n.data("external-padding")) : i.externalPadding,
                h = i.fullscreen || i.fullwidth ? a(t).width() - c : o,
                u = i.fullscreen ? s - c : i.carousel && i.carouselVisible > 1 && !i.carouselScaleHeight ? l : i.fullwidth && o / d > l ? l - c : o / d - c,
                p = u > i.scaleMinHeight ? !1 : !0,
                f = p ? h / i.scaleMinHeight : h / u,
                m = i.carouselScaleHeight && 1 === i.carouselVisible ? !0 : !1,
                g = i.forceFit || e.is("[data-force-fit]");
            if (n.data("newSW", h), n.data("newSH", u), i.carousel) {
                var v = null;
                clearTimeout(v), n.css({
                    width: Math.round(h) + "px"
                }), v = setTimeout(function() {
                    n.css({
                        height: n.data("first-load") && m ? n.find("li:first-child").find(".tms-content-scalable, img").outerHeight() + "px" : !n.data("first-load") && m ? e.find(".tms-content-scalable, img").outerHeight() : "auto"
                    })
                }, 100)
            } else n.css({
                width: Math.round(h) + "px",
                ...
                height: n.height() + "px"
            }), u = u > i.scaleMinHeight || "auto" === i.scaleMinHeight ? u : i.scaleMinHeight, n.data("newSH", u);
            if (!n.data("setup") || i.carousel && i.carouselVisible > 1) return !1;
            var b = e.is("[data-image]") ? "image" : "video",
                y = e.is("[data-video-bkg]") ? !0 : !1,
            ...
            e.find("img, iframe, video, .mejs-container").not(".tms-caption img, .tms-caption iframe, .tms-caption video").each(function() {
                var t, n, o;
                if ("image" === b ? (t = a(this).width(), n = a(this).height()) : "video" === b && ((!i.respectRatio && !y || i.fullscreen && !y) && e.addClass("tms-video-no-ratio"), y ? (t = i.fullwidth ? u * x : h, n = i.fullwidth ? u : h / x) : (t = a(this).attr("width") && h > a(this).attr("width") ? a(this).attr("width") : h, n = t / x)), o = t / n, "image" === b && i.fullscreen || g || "video" === b && y) {
                    if (a(this).is("img") && !a(this).data("loaded")) return !1;
                    a(this).css(f > o ? {
                        width: i.fullwidth && !g ? "auto" : h + "px",
                        height: Math.round(h / o) + "px",
                        top: Math.round(-((h / o - u) / 2)) + "px",
                        left: 0
                    } : {
                        width: !i.fullwidth || g || y ? Math.round(u * o) + "px" : "auto",
                        height: u + "px",
                        top: 0,
                        left: Math.round(-((u * o - h) / 2)) + "px"
                    })
                } else "video" === b && a(this).css({
                    width: Math.floor(t) + "px",
                    height: Math.floor(n) + "px",
                    top: Math.floor((u - n) / 2) + "px",
                    left: Math.floor((h - t) / 2) + "px"
                })
            }), w(e, i)
        },
        w = function(e, t) {
            ...
            return !t.captionScaling || t.carouselVisible > 1 ? !1 : (e.find(".tms-caption").each(function() {
                if (!a(this).is("[data-no-scale]")) {
                    var e = a(this),
                        ...
                        x = e.data("bl"),
                        $ = e.data("fs"),
                        S = 0 === e.data("lh") ? $ : e.data("lh"),
                        C = e.is("[data-offsetx]") ? parseFloat(e.data("offsetx")) : 0,
                        T = e.is("[data-offsety]") ? parseFloat(e.data("offsety")) : 0,
                        z = 0 > o * (C / r) ? o * (C / r) : o * (C / r) > C ? C : o * (C / r),
                        O = 0 > s * (T / l) ? o * (T / r) : o * (T / r) > T ? T : s * (T / l);
                    t.fullwidth && T > O && 0 > O && (O = T);
                    var F;
                    e.find("img, iframe, video").length && (F = o * (d / r) > d ? d : o * (d / r) > o ? o : o * (d / r)), e.css(e.find("img").length || e.find("iframe, video").length ? {
                        width: F + "px",
                        height: e.children("iframe, video").length ? F / 1.778 + "px" : "auto"
                    } : {
                        fontSize: o * ($ / r) > $ ? $ : o * ($ / r) + "px",
                        lineHeight: o * (S / r) > S ? S + "px" : o * (S / r) + "px",
                        paddingTop: o * (c / r) > c ? c : o * (c / r) + "px",
                        paddingRight: o * (h / r) > h ? h : o * (h / r) + "px",
                        paddingBottom: o * (u / r) > u ? u : o * (u / r) + "px",
                        paddingLeft: o * (p / r) > p ? p : o * (p / r) + "px",
                        marginTop: o * (f / r) > f ? f : o * (f / r) + "px",
                        marginRight: o * (m / r) > m ? m : o * (m / r) + "px",
                        marginBottom: o * (g / r) > g ? g : o * (g / r) + "px",
                        marginLeft: o * (v / r) > v ? v : o * (v / r) + "px",
                        borderTopWidth: o * (w / r) > w ? w : Math.ceil(o * (w / r)) + "px",
                        borderRightWidth: o * (b / r) > b ? b : Math.ceil(o * (b / r)) + "px",
                        borderBottomWidth: o * (y / r) > y ? y : Math.ceil(o * (y / r)) + "px",
                        borderLeftWidth: o * (x / r) > x ? x : Math.ceil(o * (x / r)) + "px",
                        whiteSpace: "nowrap"
                    }), e.css({
                        top: "top" === n ? 0 + O : "bottom" === n ? s - e.outerHeight() - O : (s - e.outerHeight()) / 2 + O + "px",
                        left: "left" === i ? 0 + z : "right" === i ? o - e.outerWidth() - z : (o - e.outerWidth()) / 2 + z + "px"
                    })
                }
            }), i)
        },
        b = function(e, t) {
            return t.carouselVisible > 1 ? !1 : (e.find(".tms-caption").not(".no-transition").each(function() {
                var e = a(this),
                    ...
                    o = e.data("tz") ? parseFloat(e.data("tz")) : 0,
                    s = e.data("rx") ? parseFloat(e.data("rx")) : 0,
                    r = e.data("ry") ? parseFloat(e.data("ry")) : 0,
                    l = e.data("rz") ? parseFloat(e.data("rz")) : 0,
                    d = e.data("s") ? parseFloat(e.data("s")) : 1;
                e.css(k ? {
                    transition: "none",
                    transform: "translate3d(" + i + "px, " + n + "px, " + o + "px)rotate3d( 1, 0, 0, " + s + "deg)rotate3d( 0, 1, 0, " + r + "deg)rotate3d( 0, 0, 1, " + l + "deg)scale3d(" + d + ", " + d + ", " + d + ")",
                    opacity: t
                } : {
                    opacity: 0
                })
        ...
        y = function(e, t, n) {
            ...
            try {
                if (e.find("iframe").length) {
                    o = "#" + e.find("iframe").attr("id");
                    var s = a(o).attr("src");
                    i !== s && s.indexOf("vimeo") > -1 ? (o = $f(a(o)[0]), o.api("play" === t && n.autoPlay ? "play" : "pause")) : i !== s && s.indexOf("youtu") > -1 && (o = o.replace("#", ""), "play" === t && n.autoPlay ? x[o].playVideo() : x[o].stopVideo())
                } else e.find("video").length && (o = "#" + e.find("video").attr("id"), "play" === t && n.autoPlay ? a(o)[0].play() : a(o)[0].pause())
            } catch (r) {}
        },
        x = {},
        $ = !1,
        S = !1,
        C = function(n, o) {
            if (!o.useVideoAPI || o.carouselVisible > 1) return !1;
            var s = n.attr("src"),
                r = new Date;
            if (n.attr("id", "video-" + r.getTime()), i !== s && s.indexOf("vimeo") > -1) {
                if (n.attr("src", n.attr("src") + "&player_id=" + n.attr("id")).addClass("vimeo"), !$) {
                    $ = !0;
                ...
                n.on("load", function() {
                    ...
                    t.addEvent("ready", function() {
                        i && o.autoPlay && t.api("play"), t.addEvent("finish", function() {
                            o.replayOnEnd && t.api("play")
                        })
                    })
                })
            } else if (i !== s && s.indexOf("youtu") > -1) {
                if (n.addClass("youtube"), !S) {
                    S = !0;
                        ...
                        x[e] = new YT.Player(e, {
                            events: {
                                onStateChange: function(a) {
                                    a.data === YT.PlayerState.ENDED && o.replayOnEnd && x[e].playVideo()
                                },
                                onReady: function() {
                                    t && o.autoPlay && x[e].playVideo()
                                }
                            }
                        })
                    })
                ...
                var p = e.getElementById(n.attr("id")),
                    f = n.closest("li").is(":first-child") ? !0 : !1;
                f && o.autoPlay && (p.load(), p.autoplay = !0), n.parent().is("[data-video-bkg]") && (p.muted = o.muteBkgVideo), o.replayOnEnd && (p.loop = !0)
            }
        },
        T = function() {
            var a = {};
    ...
    var z, O = e.body || e.documentElement,
        F = O.style,
        k = F.transition !== i || F.WebkitTransition !== i || F.MozTransition !== i || F.MsTransition !== i || F.OTransition !== i,
        A = ["WebkitTransform", "MozTransform", "OTransform", "msTransform"];
    for (var H in A) F[A[H]] !== i && (z = "-" + A[H].replace("Transform", "").toLowerCase());
    var P = z + "-transform",
...
$(document).ready(function() {
    ...
    var e = ".header",
        ...
        w = ".portfolio-filter-menu",
        y = "0.7s",
        C = !1,
        x = [".video-container iframe", ".video-container object"],
        b = ["www.youtube.com", "player.vimeo.com"],
        S = ".mejs-container audio, .mejs-container video",
        T = ".carousel-slider",
        k = ".content-slider",
        z = ".tm-slider-container.fullscreen",
        P = ".full-width-slider",
        O = ".logo-slider",
        A = ".hero-slider",
        ...
        L = ".next-team-slider",
        W = ".portfolio-recent-slider",
        D = ".previous-portfolio-recent-slider",
        V = ".next-portfolio-recent-slider",
        j = "#tm-lightbox",
        q = ".lightbox-link",
        Q = ".form-element",
        R = ".form-response",
        ...
        Z = "Please wait.",
        Y = "Sending...",
        G = "You have been added to our list!",
        X = "Oh boy an error occurred, please try again.",
        J = "Please fill out required fields.",
        K = "Please enter a valid email address.",
        ei = ".contact-form",
        ii = ".required-field",
        oi = "Please wait.",
        ti = "Sending...",
        ai = "Thank you, your email has been received!",
        ni = "Oh boy an error occurred, please try again.",
        si = "Please fill out required fields.",
        ri = "Please enter a valid email address.",
        li = ["images/assets/map-marker.png", "images/assets/map-marker-2.png"],
        di = [
            [40.723301, -74.002988],
            [40.691052, -73.925457]
        ],
        ci = ["Downtown New York Office<br>44 St. West 32", "The Brooklyn Office<br>East Village 55th St."],
        hi = 45,
        ui = 53,
        fi = 12,
        pi = !1,
        ...
        Ci = !0,
        xi = "body",
        bi = '.fade-location, .logo a, .footer-logo a, .navigation a, .side-navigation a, .overlay-navigation a, [class*="portfolio-"] .overlay-link, .post-media .overlay-link, .post-title a, .post-read-more a, .pagination-previous, .pagination-next',
        Si = ".no-page-fade, .mail-link, .lightbox-link, .contains-sub-menu, .blog .pagination-previous, .blog .pagination-next, .disabled, .scroll-link",
        Ti = "webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",
        ki = {
            init: function() {
                ki.siteHeader(), ki.retinize(), ki.equalize(768), ki.parallax(".parallax.fixed-height", !0, !1, !0), ki.parallax(".parallax.fullscreen", !0, !0, !0), ki.fullScreenSection(), ki.masonry(), ki.logoSlider(), ki.heroSlider(), ki.testimonialSlider(), ki.teamSlider(), ki.portfolioSlider(), ki.carouselSlider(), ki.contentSlider(), ki.fullScreenSlider(), ki.fullWidthSlider(), ki.lightbox(), ki.counter(".stat", ".stat-counter", !1), ki.horizon(".horizon", ".parallax .horizon", "easeInOutQuint", !1, 1), ki.videos(), ki.mediaElement(), ki.signupForm(), ki.contactForm(), ki.enablePlaceHolder(), document.getElementById("map-canvas") && google.maps.event.addDomListener(window, "load", ki.googleMap), ki.pageFade(), ki.scrollToSection()
            },
            retinize: function() {
                $(l).retinizeImages()
            },
            ...
            parallax: function(e, i, o, t) {
                $(e).snowBridge({
                    ...
                    parallaxFactor: .6,
                    onLoaded: function() {
                        ki.horizon(".horizon", "", "easeInOutQuint", !1, 1)
                    }
                })
            },
            horizon: function(e, i, o, t, a) {
                $(e).not(i).horizon({
                    easing: o,
                    recurring: t,
                    threshold: a
            ...
            siteHeader: function() {
                ...
                var d, c, h, u, f, p, g, m, v, w = 0,
                    ...
                    C = $(e),
                    x = ".header-2, .header-3";
                i = i.split(".").join(""), o = o.split(".").join(""), t = t.split(".").join(""), a = a.split(".").join(""), n = n.split(".").join(""), s = s.split(".").join(""), r = r.split(".").join("");
                var b = function(i) {
                        return $("body").hasClass("mobile") || y > d ? !1 : (p && $(i).scrollTop() >= p || 0 === p ? ($(e).addClass(o), g && m && $(e).addClass(r)) : ($(e).removeClass(o), g && m && $(e).removeClass(r)), u && $(i).scrollTop() >= u ? $(e).addClass(t) : $(e).removeClass(t), f && $(i).scrollTop() >= f ? $(e).addClass(a) : $(e).removeClass(a), v = $(i).scrollTop(), v > w ? (g && $(i).scrollTop() >= g && $(e).addClass(n), $(e).removeClass(s)) : w > v && (g && $(i).scrollTop() <= g && ($(e).removeClass(n), $(e).removeClass(s)), !g || $(i).scrollTop() < g || $(i).scrollTop() > m || ($(e).addClass(s), $(s).on(Ti, function(o) {
                            return o.stopPropagation(), o.target !== $(i)[0] ? !1 : void $(e).removeClass(s)
                        }))), void(w = v))
                    },
                    S = function() {
                        return l(), $("body").hasClass("mobile") ? !1 : (d > y && C.is(x) && C.css({
                            height: C.outerHeight() + "px"
                        }), d > y && $(window).scrollTop() >= p ? ($(e).addClass(o), g && m && $(e).addClass(r)) : ($(e).removeClass(o), g && m && $(e).removeClass(r)), d > y && $(window).scrollTop() < u ? $(e).removeClass(t) : d > y && $(window).scrollTop() > u && $(e).addClass(t), d > y && $(window).scrollTop() < f ? $(e).removeClass(a) : d > y && $(window).scrollTop() > f && $(e).addClass(a), void(y > d && $(e).removeClass(a)))
                    };
                $(window).on("scroll", function() {
                    b($(this))
                }), $(window).on("resize", function() {
                ...
                var e = function() {
                        ...
                        if ($(c).find(h).length > 1) {
                            ...
                            if (o) {
                                ...
                                for (var t = 1; t < $(c).children().length; t++) e = $(c).children().eq(t - 1).attr("id"), $(c).find("#" + e).data("index", t), $(c).find(i).append('<a href="#' + e + '" id="fs-pagination-' + t + '" data-index="' + t + '" class="fs-bullet-nav" />');
                                $(window).on("resize", function() {
                                    a()
                                });
                                var a = function() {
                                ...
                                n.each(function() {
                                    $(this).on("click", function(i) {
                                        ...
                                        e = $(this).attr("href"), ki.scrollPage(e, 0)
                                    })
                                })
                            }
                            $(window).on("scroll", function() {
                            ...
                            var s = function(e) {
                                ...
                                r = function(e) {
                                    if (ki.isElementVisible(e, g) && o) {
                                        $(i).css({
                                            opacity: 1
                                        });
                                        var t = $(c).find(e).data("index");
                                        i.find(".active").removeClass("active"), i.find("#fs-pagination-" + t).addClass("active"), e.hasClass("nav-dark") ? i.addClass("nav-dark") : i.removeClass("nav-dark")
                                    }
                                    $(i).css(o && ki.isElementVisible($(c), g) ? {
                                        opacity: 1,
                                        visibility: "visible"
                                    } : {
                                        opacity: 0,
                    ...
                    t = $(window).height();
                $(window).on("resize", function() {
                    o = $(window).width(), t = $(this).height(), i()
                }).resize(), e()
            },
            ...
            isElementVisible: function(e, i) {
                if (void 0 === e.offset()) return console.log("template-functions.js@isElementVisible: " + e.selector + " cannot be found in your html page."), !1;
                var o = $(window).height(),
                    t = $(window).scrollTop(),
                    a = t + $(window).height(),
                    n = e.offset().top,
                    ...
                    r = n + o * i;
                return e.is($(c)) || (r > a || t > s ? e.removeClass("in-view") : e.addClass("in-view")), a >= r && s >= t
            },
            ...
            masonry: function() {
                $(m).each(function() {
                    var e, i = $(this),
                        o = i.closest(".section-block").hasClass("fit-rows") ? "fitRows" : "masonry";
                    i.closest(".section-block").is(".portfolio-5, .portfolio-6, .masonry-set-dimensions") ? (i.closest(".section-block").is(".full-width.no-margins") && ki.masonryWrapperWidth(i), e = ki.masonryColWidth(i), ki.masonryThumbSizes(i, ki.masonryColWidth(i))) : e = ".grid-sizer", imagesLoaded(i, function() {
                        i.isotope({
                            filter: "*",
                        ...
                        var t = i.children().length - 1;
                        $("body").hasClass("transition-support") || i.removeClass("fade-in-progressively"), i.children().each(function(e) {
                            $(this).delay(100 * e).animate({
                                opacity: 1
                            }, 500, "easeInOutQuart", function() {
                                e === t && i.removeClass("fade-in-progressively")
                            })
                        }), $(window).on("resize", function() {
                            i.closest(".section-block").is(".full-width.no-margins") && ki.masonryWrapperWidth(i), ki.masonryThumbSizes(i, ki.masonryColWidth(i)), C ? i.isotope({
                                transitionDuration: y,
                                masonry: {
                                    columnWidth: ".grid-sizer" !== e ? ki.masonryColWidth(i) : ".grid-sizer"
                                }
                            }) : (i.removeClass("filtering"), i.isotope({
                    ...
                    $(this).find("a").on("click", function(e) {
                        ...
                        var i = $(this).closest(w).data("target-grid") ? $(this).closest(w).data("target-grid") : $('[class*="portfolio-"]').find(".masonry-grid"),
                            o = $(this).attr("data-filter");
            ...
            masonryWrapperWidth: function(e) {
                var i = Math.ceil(1.001 * e.closest(".section-block").width());
                e.css({
                    maxWidth: i + "px",
                    width: i + "px"
                })
            },
            masonryColWidth: function(e) {
                var i, o = $(window).width(),
                    t = Math.ceil(e.closest(".section-block").width()),
                    a = e.closest(".section-block").is(".full-width.no-margins") ? Math.ceil(1.001 * t) : e.width();
                return e.closest(".section-block").is(".full-width.small-margins, .full-width.no-margins") ? (e.hasClass("content-grid-2") && (i = 480 > o ? a / 1 : a / 2), e.hasClass("content-grid-3") && (i = o > 768 ? a / 3 : 768 >= o && o > 480 ? a / 2 : a / 1), e.hasClass("content-grid-4") && (i = o > 1140 ? a / 4 : 1140 >= o && o > 768 ? a / 3 : 768 >= o && o > 480 ? a / 2 : a / 1), e.hasClass("content-grid-5") && (i = o > 1300 ? a / 5 : 1300 >= o && o > 1140 ? a / 4 : o > 1140 || 768 > o ? 768 >= o && o > 480 ? a / 2 : a / 1 : a / 3), e.hasClass("content-grid-6") && (i = o > 1300 ? a / 6 : 1300 >= o && o > 1140 ? a / 4 : o > 1140 || 768 > o ? 768 >= o && o > 480 ? a / 2 : a / 1 : a / 3)) : (e.hasClass("content-grid-2") && (i = 600 > o ? a / 1 : a / 2), e.hasClass("content-grid-3") && (i = o > 960 ? a / 3 : 960 >= o && o > 600 ? a / 2 : a / 1), e.hasClass("content-grid-4") && (i = o > 1140 ? a / 4 : 1140 >= o && o > 960 ? a / 3 : 960 >= o && o > 600 ? a / 2 : a / 1), e.hasClass("content-grid-5") && (i = o > 1300 ? a / 5 : 1300 >= o && o > 1140 ? a / 4 : 1140 >= o && o > 960 ? a / 3 : 960 >= o && o > 600 ? a / 2 : a / 1), e.hasClass("content-grid-6") && (i = o > 1300 ? a / 6 : 1300 >= o && o > 1140 ? a / 4 : 1140 >= o && o > 960 ? a / 3 : 960 >= o && o > 600 ? a / 2 : a / 1)), i = Math.floor(i)
            },
            masonryThumbSizes: function(e, i) {
                var o, t = $(window).width(),
                    a = 2,
                    n = $(".portfolio-5, .masonry-set-dimensions").hasClass("no-margins") ? 0 : parseFloat(e.find(".grid-item").css("padding-left")),
                    s = e.closest(".section-block").is(".portfolio-5, .masonry-set-dimensions") ? e.is("[data-grid-ratio]") ? parseFloat(e.data("grid-ratio")) : 1.5 : 1;
                if (o = Math.floor((i - n) / s + n), e.closest(".section-block").is(".portfolio-5, .masonry-set-dimensions")) {
                    var r = e.closest(".section-block").is(".full-width.small-margins, .full-width.no-margins") ? 480 : 600;
                    e.find(v).each(function() {
                        $(this).css($(this).is(".large, .masonry-stamp.large") ? $(this).is(".portrait, .masonry-stamp.portrait") ? {
                            width: t > r ? Math.floor(i * a) + "px" : i + "px",
                            height: t > r ? Math.floor(2 * o * a) + "px" : 2 * o + "px"
                        } : {
                            width: t > r ? Math.floor(i * a) + "px" : i + "px",
                            height: t > r ? Math.floor(o * a) + "px" : o + "px"
                        } : $(this).is(".wide, .masonry-stamp.wide") ? {
                            width: t > r ? Math.floor(i * a) + "px" : i + "px",
                            height: t > r ? o + "px" : o / 2 + "px"
                        } : $(this).is(".portrait, .masonry-stamp.portrait") ? {
                            width: i + "px",
                            height: Math.floor(o * a) + "px"
                        } : {
                            width: i + "px",
                            height: o + "px"
                        })
                ...
                e.closest(".section-block").is(".portfolio-6") && e.find(v).each(t > 600 ? function() {
                    $(this).hasClass("horizontal") ? $(this).hasClass("two-third") ? $(this).children(".item-description").length ? $(this).css({
                        width: Math.floor(i * (a + 1)) + "px",
                        height: Math.floor(o) + "px"
                    }) : $(this).addClass("no-description").css({
                        width: Math.floor(i * a) + "px",
                        height: Math.floor(o) + "px"
                    }) : $(this).css({
                        width: Math.floor(i * a) + "px",
                        height: Math.floor(o) + "px"
            ...
            signupForm: function() {
                $(N).submit(function(e) {
                    ...
                    var i = $(this),
                        ...
                        h = !1,
                        u = !1;
                    if (U = U.split(".").join(""), t.removeClass(U), t.each(function() {
                            $(this).attr("required") && ($(this).val() || (c = !0, $(this).addClass(U), o.hide().text(J).fadeIn(200)))
                        }), c || (h = !0), a.val() && !ki.isValidEmail(a.val()) ? (o.hide().text(K).fadeIn(200), a.addClass(U)) : u = !0, "" !== n.val()) return !1;
                    if (c && a.val() && !ki.isValidEmail(a.val()) && o.hide().text(J + " " + K).fadeIn(200), h && u) {
                        var f = $(s).val();
                        $(s).css({
                            width: $(s).outerWidth() + "px"
                        }).val(Y).attr("disabled", !0), o.hide().text(Z).fadeIn(200), $.ajax({
                            url: r,
                            type: l,
                            data: d,
                            dataType: "json"
                            ...
                            try {
                                e.response === !0 ? (o.text(G), o.delay(1500).fadeOut(200), t.val("")) : o.hide().text(e.json.error_message).fadeIn(200)
                            } catch (i) {
            ...
            contactForm: function() {
                $(ei).submit(function(e) {
                    ...
                    var i = $(this),
                        ...
                        h = !1,
                        u = !1;
                    if (ii = ii.split(".").join(""), t.removeClass(ii), t.each(function() {
                            $(this).attr("required") && ($(this).val() || (c = !0, $(this).addClass(ii), o.hide().text(si).fadeIn(200)))
                        }), c || (h = !0), a.val() && !ki.isValidEmail(a.val()) ? (o.hide().text(ri).fadeIn(200), a.addClass(ii)) : u = !0, "" !== n.val()) return !1;
                    if (c && a.val() && !ki.isValidEmail(a.val()) && o.hide().text(si + " " + ri).fadeIn(200), h && u) {
                        var f = $(s).val();
                        $(s).css({
                            width: $(s).outerWidth() + "px"
                        }).val(ti).attr("disabled", !0), o.hide().text(oi).fadeIn(200), $.ajax({
                            url: r,
                            type: l,
                            data: d,
                            dataType: "json"
                            ...
                            try {
                                if (e.response === !0) o.text(ai), o.delay(1500).fadeOut(200), t.val("");
                                else {
                                    ...
                                    o.hide().text(ni + " " + i).fadeIn(200)
                                }
                            } catch (a) {
                                console.log("error in parsing returned ajax data: " + a), console.log(e), o.hide().text("Error occurred. Please see the console for details.").fadeIn(200)
                            }
                        }).fail(function(e, i, t) {
            ...
            googleMap: function() {
                for (var e, i, o = yi ? -100 : 0, t = {
                        zoom: fi,
                        center: new google.maps.LatLng(di[0][0], di[0][1]),
                        mapTypeControl: gi,
                    ...
                    }, a = new google.maps.Map(document.getElementById("map-canvas"), t), n = 0, s = 0; s < di.length; s++) e = new google.maps.Marker({
                    position: new google.maps.LatLng(di[s][0], di[s][1]),
                    map: a,
                    icon: new google.maps.MarkerImage(li[n], null, null, null, new google.maps.Size(hi, ui))
                }), i = new google.maps.InfoWindow({
                    content: ci[s]
                }), google.maps.event.addListener(e, "click", function(e, o) {
                    return function() {
                        i.setContent(ci[o]), i.open(a, e)
                    }
                }(e, s)), n++;
                google.maps.event.addDomListener(window, "resize", function() {
                    var e = a.getCenter();
                    google.maps.event.trigger(a, "resize"), a.setCenter(e)
                })
            },
            pageFade: function() {
                return Ci ? void $(bi).not(Si).on("click", function(e) {
                    e.preventDefault();
                    var i = this.href;
                    $("body").hasClass("transition-support") ? $(xi).addClass("page-fade-out").on(Ti, function(e) {
                        return e.stopPropagation(), e.target !== $(this)[0] ? !1 : void ki.goToNewPage(i)
                    }) : ki.goToNewPage(i)
                }) : !1
            },
